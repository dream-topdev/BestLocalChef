...
class ChefRegister extends Component<{}> {
  constructor(props) {
    super(props);
    this.state = {
      checked: true,
        ...
        <ScrollView
          ...
          <View style={{flexDirection: 'column', marginBottom: 20}}>
            <View style={styles.contentViewStyle}>
              ...
              <Text style={styles.middleTextStyle}>College</Text>
              <Field name="college" component={this.renderTextInput} />
              ...
              {!this.state.checked && (
                <Text
                  style={{fontSize: 14, color: 'red', paddingHorizontal: 15}}>
